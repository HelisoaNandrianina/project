...
// ─── Points autour d'Antananarivo et grandes villes malgaches ────────────────
// Centre : Antananarivo  lat ≈ -18.91  lng ≈ 47.54
export const mockDataPoints: DataPoint[] = [
  // Antananarivo centre & proches banlieues
  { id: 'DP001', name: 'Client Industriel A',      lat: -18.910, lng: 47.537, zone: 'Zone Nord',   score: 92, status: 'active',   type: 'client',   revenue: 48500,  createdAt: '2026-01-15' },
  { id: 'DP002', name: 'Prospect PME B',            lat: -18.882, lng: 47.528, zone: 'Zone Nord',   score: 67, status: 'pending',  type: 'prospect', revenue: 0,      createdAt: '2026-02-01' },
  { id: 'DP003', name: 'Partenaire Logistique C',   lat: -18.930, lng: 47.562, zone: 'Zone Est',    score: 85, status: 'active',   type: 'partner',  revenue: 32000,  createdAt: '2026-01-20' },
  { id: 'DP004', name: 'Client Retail D',           lat: -18.960, lng: 47.510, zone: 'Zone Sud',    score: 41, status: 'inactive', type: 'client',   revenue: 12400,  createdAt: '2025-11-10' },
  { id: 'DP005', name: 'Client Tech E',             lat: -18.920, lng: 47.580, zone: 'Zone Est',    score: 78, status: 'active',   type: 'client',   revenue: 67800,  createdAt: '2026-03-05' },
  { id: 'DP006', name: 'Prospect Finance F',        lat: -18.875, lng: 47.505, zone: 'Zone Ouest',  score: 55, status: 'pending',  type: 'prospect', revenue: 0,      createdAt: '2026-04-01' },
  { id: 'DP007', name: 'Client Santé G',            lat: -18.975, lng: 47.545, zone: 'Zone Sud',    score: 88, status: 'active',   type: 'client',   revenue: 91200,  createdAt: '2025-09-18' },
  { id: 'DP008', name: 'Partenaire Tech H',         lat: -18.898, lng: 47.595, zone: 'Zone Est',    score: 72, status: 'active',   type: 'partner',  revenue: 44600,  createdAt: '2026-02-14' },
  { id: 'DP009', name: 'Client GovTech I',          lat: -18.858, lng: 47.532, zone: 'Zone Nord',   score: 94, status: 'active',   type: 'client',   revenue: 130000, createdAt: '2025-08-05' },
  { id: 'DP010', name: 'Prospect Energie J',        lat: -18.985, lng: 47.570, zone: 'Zone Sud',    score: 48, status: 'pending',  type: 'prospect', revenue: 0,      createdAt: '2026-04-10' },
];
